...
try:
    ...
    st.session_state["Net"] = cv2.dnn.readNet("Nhan_Dien_Bien_Bao_Duong_Bo/road_sign_detection_model.onnx")
    print(st.session_state["LoadModel"])
    print('Load model lần đầu')
     
filename_classes = 'Nhan_Dien_Bien_Bao_Duong_Bo/road_signs_classes.txt'
mywidth  = 640
myheight = 640
