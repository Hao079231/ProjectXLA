...
try:
    ...
    st.session_state["Net"] = cv2.dnn.readNet("Nhan_Dien_Trai_Cay/fruit_detection_model.onnx")
    print(st.session_state["LoadModel"])
    print('Load model lần đầu')
     
filename_classes = 'Nhan_Dien_Trai_Cay/fruit_detection_classes_yolo.txt'
mywidth  = 640
myheight = 640
