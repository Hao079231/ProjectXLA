...
import random
import cv2
st.title('Nhận diện chữ số viết tay mnsist')
...
if 'is_load' not in st.session_state:
    # load model
    model_architecture = 'Nhan_Dien_Chu_So_Viet_Tay_MNIST/digit_config.json'
    model_weights = 'Nhan_Dien_Chu_So_Viet_Tay_MNIST/digit_weight.h5'
