...
st.set_page_config(
    page_title="Nhận diện đối tượng",
    page_icon="🔍",
    layout="wide"
)
...
try:
    ...
    st.session_state["Net"] = cv2.dnn.readNet("Nhan_Dien_Doi_Tuong/object_detection_model.onnx")
    print(st.session_state["LoadModel"])
    print('Load model lần đầu')
     
filename_classes = 'Nhan_Dien_Doi_Tuong/object_detection_classes_yolo.txt'
mywidth  = 640
myheight = 640
